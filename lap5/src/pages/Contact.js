    ...
    <Container className="mt-4">
      <Form noValidate validated={validated} onSubmit={handleSubmit}>
        <Row className="mb-3">
          ...
          <Form.Group as={Col} md="4" controlId="validationCustomUsername">
            ...
            <InputGroup hasValidation>
              ...
              {/* SỬA TẠI ĐÂY: Dùng Form.Control.Feedback thay vì Form.Group.Feedback */}
        ...
        <Form.Group className="mb-3">
          {/* SỬA TẠI ĐÂY: Sử dụng thuộc tính feedback trực tiếp trong Form.Check theo chuẩn React Bootstrap */}
          <Form.Check 
            required 
